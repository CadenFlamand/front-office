  ...
  return (
    <div className="flex flex-1 flex-col items-center bg-zinc-50 px-6 py-16 dark:bg-black">
      {/* See app/[leagueId]/page.tsx's identical grid for why this is a
          grid with main independently centered (equal 1fr flanking
          tracks) rather than centering main+aside as a single block, why
          the aside uses justify-self-end to sit near the outer edge
          instead of hugging main, and why the reveal breakpoint is the
          exact custom value 1440px rather than a stock xl:/2xl:. */}
